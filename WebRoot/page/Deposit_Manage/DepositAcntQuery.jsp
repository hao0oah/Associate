...
<head>
	...
	<script type="text/javascript" src="page/Deposit_Manage/DepositAcntQuery.js" charset="utf-8"></script>
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="page/style/images/title_arrow.gif"/> 存款账户查询
        </div>
    ...
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <thead>
            <tr align="CENTER" valign="MIDDLE" id="TableTitle">
				...
				<td width="200">账号</td>
				<td width="130">凭证号</td>
				<td width="150">开户日期</td>
				<td width="150">到期日</td>
				<td width="130">当前余额</td>
				<td>相关操作</td>
			</tr>
		</thead>
		<!--显示数据列表-->
